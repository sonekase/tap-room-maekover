...
function SeasonalProduce(){
  ...
  return(
    <div>
      <h1 style={{textAlign:'center', color:'#294223'}}>Available Keg's</h1>
      <hr/>
        <style jsx>{`
          .kegStyle {
